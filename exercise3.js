...
search online about this method and create a website with a div tag 
combining a random joke given an array of jokes.
Use Math.random and fetch jokes froem the internet(Use any website to create the array).
